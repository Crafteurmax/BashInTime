...
public class CommandParser : MonoBehaviour
{
    ...
    private void SafePrepare(string[] arguments, Action<string, string, string> callback, string userCommand)
    {
        ...
        //Detection d'arguments, safe car chemin relatifs transform�s en chemins absolus virtuels
    ...
    //Fonction interm�diaire pour prendre en charge l'entree/sortie avec la securite sur les fichiers de sortie
    ...
    */
    ...
    public void DetectPalais(string detectString)
    {
        ...
        else if (detectString.Contains("32XXXX"))
        {
            PalaisMental.current.AddMemory(7);
        }
        else if (detectString.Contains("XX76XX"))
        {
